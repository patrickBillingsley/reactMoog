...
class LoudnessContour extends Component {
    constructor(props) {
        super(props);
    }
                ...
                <div className='row modifiers__loudness-contour'>
                    <div className='col-4 knob'>
                        ...
                        <Knob
                            ...
                            value={this.props.loudnessContour.attackTime}
                            min={0}
                            max={2000}
                            step={1}
                            rotateDegrees={180}
                            ...
                            skin={skins.s16}
                            preciseMode={false}
                            onChange={value => this.props.handleOnChange(value, 'loudnessContour', 'attackTime')}
                        />
                    </div>
                    <div className='col-4 knob'>
                        ...
                        <Knob
                            ...
                            value={this.props.loudnessContour.decayTime}
                            min={0}
                            max={2000}
                            step={1}
                            rotateDegrees={180}
                            ...
                            skin={skins.s16}
                            preciseMode={false}
                            onChange={value => this.props.handleOnChange(value, 'loudnessContour', 'decayTime')}
                        />
                    </div>
                    <div className='col-4 knob'>
                        ...
                        <Knob
                            ...
                            value={this.props.loudnessContour.sustainLevel}
                            min={0}
                            max={1}
                            step={0.01}
                            rotateDegrees={180}
                            ...
                            skin={skins.s16}
                            preciseMode={false}
                            onChange={value => this.props.handleOnChange(value, 'loudnessContour', 'sustainLevel')}
                        />
                    </div>
                </div>
            </React.Fragment>
